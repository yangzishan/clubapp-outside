...
export const css = function css(el,attr,val){
    const TRANSFORM = ["transform", "scale","scaleX","scaleY","rotate","rotateX","rotateY","rotateZ","skewX","skewY","translateX","translateY","translateZ"];
...
*/
export const mTween = function mTween(op){
    let init = {
        time: 400,
        type: "easeBothStrong"
	};
